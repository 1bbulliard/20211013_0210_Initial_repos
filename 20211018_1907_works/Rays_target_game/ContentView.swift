...
struct ContentView: View
{
   ...
   // @State private var slider_int: Int = Int(sliderx)
    ...
    () -> Alert in
               Alert(title: Text("Alert Title2"), message: Text("Alert Message2. the sliders rounded value is \(Int(self.sliderx.rounded()))"  + " You scored  \(self.game.points(slidervalue:  1 )  ) this round"), dismissButton: .default(Text("Ok")))}
